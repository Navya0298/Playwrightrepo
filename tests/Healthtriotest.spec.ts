...
const context = await browser.newContext({
  userAgent: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/115.0.0 Safari/537.36'
});
const stealthPage = await context.newPage();

//await page.getByRole('checkbox', { name: 'My Checkbox Label' }).check();
await page.getByRole('checkbox').allTextContents();
